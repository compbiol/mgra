...
struct ProblemInstance {
  ...
  DECLARE_DELEGATE_CONST_METHOD(size_t, RGBcolors, RGB_color_size, size) 

  DECLARE_GETTER(size_t, stages, stages)
  DECLARE_GETTER(size_t, max_number_of_split_colors, max_number_of_split)
