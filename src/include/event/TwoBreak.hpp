...
struct TwoBreak {
    ...
    TwoBreak(vertex_t const &x1, vertex_t const &y1, vertex_t const &x2, vertex_t const &y2,
...
template<class mcolor_t>
typename event::TwoBreak<mcolor_t>::dependence_type event::TwoBreak<mcolor_t>::is_dependent(
        TwoBreak const &tested) const {
