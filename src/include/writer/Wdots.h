...
struct Wdots { 
	...
	void save_dot(const mbgraph_with_history<Mcolor>& graph, const ProblemInstance& cfg, size_t stage);
	void save_components(const mbgraph_with_history<Mcolor>& graph, const ProblemInstance& cfg, size_t stage);
