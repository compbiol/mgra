...
class TwoBreakTest : public testing::Test {
    virtual void SetUp() override {
        ...
        color_break = color_twobreak_t(verteces[0], verteces[1], verteces[2], verteces[3], Mcolor(1));
        ...
        twobreaks.push_back(twobreak_t(color_break)); //2
